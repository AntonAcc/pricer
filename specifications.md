...
- для проведения платежа используйте `PaypalPaymentProcessor::pay` или `StripePaymentProcessor::processPayment`
  Оба класса прилагаются, скопируйте их себе в проект. Оба класса принимают цену в центах в методах оплаты.
...
- приложить в Readme.md примеры HTTP запросов к двум эндпоинтам: path и тело запроса (для ручного тестирования)

Необходимо использовать Validator

При написании тестового используйте git.
